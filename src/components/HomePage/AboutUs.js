    ...
    return (
        ...
        <div className='w-full  bg-neutral '>
            ...
            <div className='grid gap-y-10'>
                ...
                <p className='text-base text-[#525252] max-w-md leading-7'> Meet our international teams made up of 86 innovators, branched into 8 departments, that influence the market throughout 20 different countries.</p>
